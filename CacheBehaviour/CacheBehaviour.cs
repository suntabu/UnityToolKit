...
namespace UnityToolKit
{
    ...
    {
        [HideInInspector, NonSerialized] private Animation _animation;
        ...
        [HideInInspector, NonSerialized] private AudioSource _audio;
        ...
        [HideInInspector, NonSerialized] private Camera _camera;
        ...
        [HideInInspector, NonSerialized] private Collider _collider;
        ...
        [HideInInspector, NonSerialized] private Collider2D _collider2D;
        ...
        [HideInInspector, NonSerialized] private ConstantForce _constantForce;
        ...
        [HideInInspector, NonSerialized] private GUIText _guiText;
        ...
        {
            get { return _guiText ? _guiText : (_guiText = GetComponent<GUIText>()); }
        }

        [HideInInspector, NonSerialized] private GUITexture _guiTexture;
        ...
        {
            get { return _guiTexture ? _guiTexture : (_guiTexture = GetComponent<GUITexture>()); }
        }

        [HideInInspector, NonSerialized] private HingeJoint _hingeJoint;
        ...
        [HideInInspector, NonSerialized] private Light _light;
        ...
        [HideInInspector, NonSerialized] private ParticleSystem _particleSystem;
        ...
        [HideInInspector, NonSerialized] private Renderer _renderer;
        ...
        [HideInInspector, NonSerialized] private Rigidbody _rigidbody;
        ...
        [HideInInspector, NonSerialized] private Rigidbody2D _rigidbody2D;
        ...
        [HideInInspector, NonSerialized] private RectTransform _rectTransform;
